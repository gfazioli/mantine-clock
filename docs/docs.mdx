...
The `size` prop accepts any valid CSS value, including `"auto"` to fill the parent container. This makes it easy to build clocks that scale with their container.
